...
from provenance.robustness.execution import (
    generate_kgw_sample as _generate_kgw_sample,
    generate_synthid_sample as _generate_synthid_sample,
    generate_watermark_samples as _generate_watermark_samples,
    resolve_experiment_transforms as _resolve_plan_transforms,
    run_plan_experiment as _plan_experiment_fn,
    wrap_advanced_transform as _wrap_advanced_transform,
    write_watermark_benchmark_results as _write_watermark_benchmark_results,
)
...
def _benchmark_plan(args: argparse.Namespace) -> int:
    ...
    print(f"Total duration: {elapsed_s:.1f}s", flush=True)
